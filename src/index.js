const config = {
	...
	"start_url": "http://teach.govt.hu/s/embed.html#https://easyfun.gg/embed/roblox.html", // url to open when the vm starts
...
function requireApiKey(env) {
	if (!env.HB_API_KEY || env.HB_API_KEY === "NULL-KEY") { // i dont think anyones gonna steal this tbh so i dont care iif this is hey please steal this type stuff
